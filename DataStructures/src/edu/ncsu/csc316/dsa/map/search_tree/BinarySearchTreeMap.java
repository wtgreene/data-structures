...
public class BinarySearchTreeMap<K extends Comparable<K>, V> extends AbstractOrderedMap<K, V> {
    ...
    protected static class BalanceableBinaryTree<K, V> extends LinkedBinaryTree<Entry<K, V>> {
        ...
        public void rotate(Position<Entry<K, V>> p) {
        	...
        	BinaryTreeNode<Entry<K, V>> parent = (BinaryTreeNode<Entry<K, V>>) parent( p );
...
//        	BinaryTreeNode<Entry<K, V>> node = (BinaryTreeNode<Entry<K, V>>) x;
        	...
        	BinaryTreeNode<Entry<K, V>> parent = (BinaryTreeNode<Entry<K, V>>) parent( x );
        	BinaryTreeNode<Entry<K, V>> grandparent = (BinaryTreeNode<Entry<K, V>>) parent( parent );
        	
        	if ( (parent.getLeft().equals(x) && grandparent.getLeft().equals(parent)) ||
        			(parent.getRight().equals(x) && grandparent.getRight().equals(parent)) ) {
        		rotate( parent );
        		return parent;
        	}
